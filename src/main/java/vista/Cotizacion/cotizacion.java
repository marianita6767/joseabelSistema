...
public class cotizacion extends javax.swing.JPanel {
    ...
    private void guardarCotizacion() {
        ...
        if (cliente.isEmpty() || nombrePedido.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Por favor, ingrese el nombre del cliente y del pedido", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        DefaultTableModel modelo = (DefaultTableModel) Tabla1.getModel();
        try {
            controlador.guardarCotizacion(cliente, nombrePedido, modelo, txt_total.getText().trim());
            JOptionPane.showMessageDialog(this, "Cotización guardada exitosamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
            reiniciarCotizacion();
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        add(HistorialCoti, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 610, 200, 50));
...
//nombre del PDF
    ...
    private void btnGuardarCotizacionActionPerformed(java.awt.event.ActionEvent evt) {
        guardarCotizacion();
    }
