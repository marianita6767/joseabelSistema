 ...
 * @author ADSO
 */
public class AlertaErrorBusqueda extends javax.swing.JDialog {

    /**
     * Creates new form AlertaErrorBusqueda
     */
    public AlertaErrorBusqueda(Frame parent, boolean modal, String error, String desea_guardar_los_datos) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 170, 160, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
        jLabel2.setText("Error de busqueda");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaErrorBusqueda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertaErrorBusqueda dialog = new AlertaErrorBusqueda(new javax.swing.JFrame(), true, "Error", "\u00bfDesea guardar los datos?");
