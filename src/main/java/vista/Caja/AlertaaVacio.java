 ...
 * @author ADSO
 */
public class AlertaaVacio extends javax.swing.JDialog {

    /**
     * Creates new form AlertaaVacio
     */
    public AlertaaVacio(Frame parent, boolean modal, String error, String desea_guardar_los_datos) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/escudo-exclamacion (1).png"))); // NOI18N
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 70, 70));
        ...
        jPanel1.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 160, 140, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaaVacio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertaaVacio dialog = new AlertaaVacio(new javax.swing.JFrame(), true, "Error", "\u00bfDesea guardar los datos?");
