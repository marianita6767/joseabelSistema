 ...
 * @author ZenBook
 */
public class materialCategoriaT extends javax.swing.JDialog {
    private int ultimaFilaSeleccionada = -1;
    /**
     * Creates new form categorias
     */
    public materialCategoriaT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        actualizarTabla();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(materialCategoriaT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
