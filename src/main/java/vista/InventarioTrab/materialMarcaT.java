 ...
 * @author ZenBook
 */
public class materialMarcaT extends javax.swing.JDialog {
    private int ultimaFilaSeleccionada = -1;
    /**
     * Creates new form materialMarca
     */
    public materialMarcaT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        actualizarTabla();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(materialMarcaT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
