 ...
 * @author ZenBook
 */
public class herramientaMarcaT extends javax.swing.JDialog {
    private int ultimaFilaSeleccionada = -1;
    /**
     * Creates new form herramientaMarca
     */
    public herramientaMarcaT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(herramientaMarcaT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
