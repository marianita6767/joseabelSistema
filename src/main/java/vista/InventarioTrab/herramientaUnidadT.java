 ...
 * @author ZenBook
 */
public class herramientaUnidadT extends javax.swing.JDialog {
     ...
     */
    public herramientaUnidadT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        actualizarTabla();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(herramientaUnidadT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
