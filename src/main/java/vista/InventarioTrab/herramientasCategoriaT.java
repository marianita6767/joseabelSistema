 ...
 * @author ZenBook
 */
public class herramientasCategoriaT extends javax.swing.JDialog {
    private int ultimaFilaSeleccionada = -1;
    /**
     * Creates new form herramientasCategoria
     */
    public herramientasCategoriaT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        actualizarTabla();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(herramientasCategoriaT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
